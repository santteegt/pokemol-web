...
const NewSuperfluidMinionForm = () => {
  ...
  const [agreemntType, setAgreementType] = useState('cfa');
          ...
          {_minions.length > 0 && (
            <>
              <Box mb={5} fontSize='md'>
                You have {_minions.length} Superfluid minion
                {_minions.length > 1 ? 's' : ''} already. Are you looking for
                the{' '}
                <Link
                  as={RouterLink}
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Box mb={3} fontSize='sm'>
              <FormControl mb={5}>
                ...
                <Select
                  ...
                  w='70%'
                  ref={register}
                  defaultValue={agreemntType}
                  onChange={() => setAgreementType(getValues('agreement'))}
                >
            ...
            <Box mb={3} fontSize='sm'>
              <FormControl mb={5}>
                ...
                <Input
                  name='details'
                  placeholder={agreemntType.toLocaleUpperCase()}
                  w='60%'
                  ref={register({
                    required: {
                      value: true,
